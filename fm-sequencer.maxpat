...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 792.0, 14.0, 24.0, 24.0 ],
					"style" : ""
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 91.0, 136.0, 29.5, 22.0 ],
									"style" : "",
									"text" : "0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 91.0, 100.0, 56.0, 22.0 ],
									"style" : "",
									"text" : "delay 20"
								}
...
,
					"patching_rect" : [ 792.0, 79.0, 55.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 91.0, 99.0, 56.0, 22.0 ],
									"style" : "",
									"text" : "delay 20"
								}
...
,
					"patching_rect" : [ 88.0, 79.0, 55.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 866.0, 414.0, 234.0, 116.0 ],
					"varname" : "bp.ADSR",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 88.0, 14.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 386.0, 434.0, 113.0, 116.0 ],
					"varname" : "bp.VCA",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 603.0, 535.0, 148.0, 116.0 ],
					"varname" : "bp.Stereo",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 88.0, 429.0, 211.0, 116.0 ],
					"varname" : "bp.FM",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 88.0, 172.0, 726.0, 232.0 ],
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-19::obj-31" : [ "Release", "Release", 0 ],
			...
			"obj-19::obj-1" : [ "Attack", "Attack", 0 ],
			"obj-6::obj-86" : [ "Amt", "Amt", 0 ],
			"obj-19::obj-32" : [ "Sustain", "Sustain", 0 ],
			...
			"obj-19::obj-29" : [ "Decay", "Decay", 0 ],
			"obj-6::obj-56" : [ "Depth", "Depth", 0 ],
			"obj-19::obj-20" : [ "Mute[1]", "Mute", 0 ]
		}
,
		"dependency_cache" : [ 			{
				"name" : "bp.Sequencer.maxpat",
